          ...
          <div class="flex-1 max-w-md">
            <div class="relative">
              <input
                ...
                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-3 focus:ring-[#2C64F9] focus:border-transparent"
                @input="handleSearch"
              />
              <svg class="w-5 h-5 text-[#2C64F9] absolute left-3 top-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
